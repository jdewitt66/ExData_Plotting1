...
par(mfrow=c(2,2))
plot(d.c$dateTime,d.c$Global_active_power,type='l',ylab='Global Active Power',
     xlab = '')
plot(d.c$dateTime,d.c$Voltage,type='l',ylab='Voltage',
     xlab='datetime')
...
legend('topright', lwd=1,col = c('black','red','blue'),
       c('Sub_metering_1','Sub_metering_2','Sub_metering_3'),bty='n',cex=.85)
plot(d.c$dateTime,d.c$Global_reactive_power,type='l',ylab='Global_reactive_power',
     xlab='datetime')
dev.off()